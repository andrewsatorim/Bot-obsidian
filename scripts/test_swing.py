"""Test Swing Strategy on 4H timeframe — catches multi-day trends.

Usage:
    python scripts/test_swing.py
"""
...
def run_backtest(bundles, symbol):
    ...
    engine = BacktestEngine(
        ...
        atr_risk_multiplier=2.0,   # wider SL for 4h
...
def main():
    ...
    print(f"{'='*110}")
    print(f"SWING STRATEGY: Multi-Day Trend Trading")
    print(f"EMA(9) cross EMA(21) + price confirmation + volume")
